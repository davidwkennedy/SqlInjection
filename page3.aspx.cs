...
namespace Injection
{
    public partial class page3 : System.Web.UI.Page
    {
        ...
        public void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            sqlCommand.Connection = sqlConnection;
            sqlCommand.CommandType = CommandType.Text;
            sqlCommand.Parameters.Add(new SqlParameter("@State",cbxState.SelectedValue));
            sqlCommand.Parameters.Add(new SqlParameter("@FeatureType", cbxFeature.SelectedValue));
            sqlCommand.Parameters.Add(new SqlParameter("@County",Request.Form["cbxCounty"].ToString()));
            sqlCommand.CommandText = "SELECT [Name], [primary_lat_dms], [Prim_Long_DMS], [prim_lat_dec],[prim_long_dec] FROM [dbo].[NationalFile] WHERE " +
            "[state] = @State AND [County] = @County AND [type] =  @FeatureType ORDER BY [Name]";
